...
option(OQS_ENABLE_KEM_PALOMA "Enable paloma algorithm family" ON)
cmake_dependent_option(OQS_ENABLE_KEM_paloma_128 "" ON "OQS_ENABLE_KEM_PALOMA" OFF)
...
cmake_dependent_option(OQS_ENABLE_KEM_ntruplus_576 "" ON "OQS_ENABLE_KEM_NTRUPLUS" OFF)
cmake_dependent_option(OQS_ENABLE_KEM_ntruplus_768 "" ON "OQS_ENABLE_KEM_NTRUPLUS" OFF) 
cmake_dependent_option(OQS_ENABLE_KEM_ntruplus_1152 "" ON "OQS_ENABLE_KEM_NTRUPLUS" OFF)
...
cmake_dependent_option(OQS_ENABLE_SIG_haetae128 "" ON "OQS_ENABLE_SIG_HAETAE" OFF)
cmake_dependent_option(OQS_ENABLE_SIG_haetae192 "" ON "OQS_ENABLE_SIG_HAETAE" OFF)
cmake_dependent_option(OQS_ENABLE_SIG_haetae256 "" ON "OQS_ENABLE_SIG_HAETAE" OFF)
...
elseif(${OQS_ALGS_ENABLED} STREQUAL "KPQC")  
    ...
    filter_algs("KEM_ntruplus_576;KEM_ntruplus_768;KEM_ntruplus_1152")
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_paloma_128_avx2 "" ON "OQS_ENABLE_KEM_paloma_128" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_paloma_192_avx2 "" ON "OQS_ENABLE_KEM_paloma_192" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_paloma_256_avx2 "" ON "OQS_ENABLE_KEM_paloma_256" OFF)
endif()
endif()
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_paloma_128_x86_64 "" ON "OQS_ENABLE_KEM_paloma_128" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_paloma_192_x86_64 "" ON "OQS_ENABLE_KEM_paloma_192" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_paloma_256_x86_64 "" ON "OQS_ENABLE_KEM_paloma_256" OFF)
endif()
endif()
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_ntruplus_576_x86_64 "" ON "OQS_ENABLE_KEM_ntruplus_576" ON)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_ntruplus_768_x86_64 "" ON "OQS_ENABLE_KEM_ntruplus_768" ON)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_ntruplus_1152_x86_64 "" ON "OQS_ENABLE_KEM_ntruplus_1152" ON)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_ntruplus_576_avx2 "" OFF "OQS_ENABLE_KEM_ntruplus_576" ON)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_ntruplus_768_avx2 "" OFF "OQS_ENABLE_KEM_ntruplus_768" ON)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_KEM_ntruplus_1152_avx2 "" OFF "OQS_ENABLE_KEM_ntruplus_1152" ON)
endif()
endif()
...
if(CMAKE_SYSTEM_NAME MATCHES "Darwin|Linux")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_haetae128_avx2 "" ON "OQS_ENABLE_SIG_haetae128" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_ARM_NEON_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_haetae128_aarch64 "" ON "OQS_ENABLE_SIG_haetae128" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Darwin|Linux")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_haetae192_avx2 "" ON "OQS_ENABLE_SIG_haetae192" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_ARM_NEON_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_haetae192_aarch64 "" ON "OQS_ENABLE_SIG_haetae192" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Darwin|Linux")
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS AND OQS_USE_POPCNT_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_haetae256_avx2 "" ON "OQS_ENABLE_SIG_haetae256" OFF)
endif()
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_ARM_NEON_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_haetae256_aarch64 "" ON "OQS_ENABLE_SIG_haetae256" OFF)
endif()
endif()
